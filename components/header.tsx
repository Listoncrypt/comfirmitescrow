        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent side="right" className="w-[300px] border-border/50 bg-card/95 backdrop-blur-xl sm:w-[400px]">
            <div className="mb-8 flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-foreground">C<span className="text-emerald-500">●</span>NFIRMED<span className="text-emerald-500 font-black">IT</span></span>
            </div>
